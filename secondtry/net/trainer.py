...
k= 16                          ##K NEAREST##
g= knn_graph_edges(k)                        ##K NEAREST##
writerb = SummaryWriter('runs/4cust{}net'.format(k))    ###CHANGE  THIS#####
net= cust4Net().to(device)                   ###CHANGE  THIS#####
...
#     g= data[i]["edge"]                      ##K NEAREST##
  ...
  torch.save(net.state_dict(), "models/4cust{}.pth".format(k))                 ###CHANGE  THIS#####